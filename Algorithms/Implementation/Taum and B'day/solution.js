...
function taumBday(b, w, bc, wc, z) {
    black = new BigNumber(b);
    white = new BigNumber(w);
    blackCost = new BigNumber(bc);
    whiteCost = new BigNumber(wc);
    exchange = new BigNumber(z);

    return (black.multiply(Math.min(whiteCost.add(exchange), blackCost))).add(white.multiply(Math.min(blackCost.add(exchange), whiteCost)));
}
